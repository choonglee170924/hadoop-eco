...
ranger 1.2.0에 presto를 적용하는 방법

-> ranger build
-> apache-ranger-2.0.0 build

apache-ranger-2.0.0 setup.sh 진행 (DB 스키마를 적용하기 위함)
ranger setup.sh 진행

해당 폴더에 presto 폴더 넣기
/ranger-admin/ews/webapp/WEB-INF/classes/ranger-plugins


```
/home/ranger/ranger-admin/ews/webapp/WEB-INF/classes/ranger-plugins/presto
[root@hadoop-3 presto]# ll
합계 6876
-rwxr-xr-x 1 ranger ranger 6412207 12월 26 17:23 presto-jdbc-310.jar
-rwxr-xr-x 1 ranger ranger  574380 12월 26 17:23 presto-spi-310.jar
-rw-r--r-- 1 ranger ranger   46156 12월 26 17:23 ranger-presto-plugin-2.0.0.jar
```
...
rangerAdmin_password=exntu123!
rangerTagsync_password=exntu123!
rangerUsersync_password=exntu123!
keyadmin_password=exntu123!
...
audit_solr_urls=http://hadoop-3:6083/solr/ranger_audits
audit_solr_user=
audit_solr_password=
...
policymgr_external_url=http://hadoop-3:6080
...
authServiceHostName=hadoop-3
authServicePort=5151
ranger_unixauth_keystore=/opt/cert/unixauthservice.jks
ranger_unixauth_keystore_password=UnIx529p
ranger_unixauth_truststore=/opt/cert/mytruststore.jks
